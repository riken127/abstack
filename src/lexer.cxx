...
Token Lexer::identifier()
{
  ...
  else if (text == "service") type = TokenType::Service;
  else if (text == "stage") type = TokenType::Stage;
  else if (text == "use") type = TokenType::Use;
  else if (text == "from") type = TokenType::From;
  else if (text == "run") type = TokenType::Run;
  else if (text == "copy") type = TokenType::Copy;
  else if (text == "env") type = TokenType::Env;
  else if (text == "expose") type = TokenType::Expose;
  else if (text == "cmd") type = TokenType::Cmd;
  else if (text == "entrypoint") type = TokenType::Entrypoint;
  else if (text == "workdir") type = TokenType::Workdir;
...
Token Lexer::symbol()
{
    ...
    switch (c)
    {
        ...
        case '=': return {TokenType::Equal, "=", line};
        default:
